...
func createCars() {
	cars = append(cars, Car{Name: "Carro 1", Price: 100})
	cars = append(cars, Car{Name: "Carro 2", Price: 200})
	cars = append(cars, Car{Name: "Carro 3", Price: 300})
}
...
func saveCar(car Car) error {
	db, err := sql.Open("sqllite3", "cars.db")
